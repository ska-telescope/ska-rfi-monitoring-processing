...
for ind_trial in range(trials):
    ...
    A0[ind_trial,:,:,:] = propagate_orbits2(step,N_steps,sats,rand_seed,load_saved=0,trial_nr = ind_trial)  # propagate the orbits with a random seed  A= [trial, sat, time, xyz]
